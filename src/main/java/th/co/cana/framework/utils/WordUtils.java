...
import th.co.cana.framework.utils.UtilConfigs.PropertyKeys;
...
public final class WordUtils {
	...
	private static final String[] NUMBER_SCALES = UtilConfigs.getArray(PropertyKeys.NUMBER_SCALE);
	private static final String[] DIGIT_WORDS = UtilConfigs.getArray(PropertyKeys.DIGIT_WORD);
	private static final String TXT_YEE = UtilConfigs.getValue(PropertyKeys.YEE);
	private static final String TXT_ZERO = UtilConfigs.getValue(PropertyKeys.ZERO);
	private static final String TXT_NEGATIVE = UtilConfigs.getValue(PropertyKeys.NEGATIVE);
	private static final String TXT_BAHT = UtilConfigs.getValue(PropertyKeys.BAHT);
	private static final String TXT_ALL = UtilConfigs.getValue(PropertyKeys.ALL);
	private static final String TXT_STANG = UtilConfigs.getValue(PropertyKeys.STANG);
	private static final String ONE_AED = UtilConfigs.getValue(PropertyKeys.ONE_AED);
